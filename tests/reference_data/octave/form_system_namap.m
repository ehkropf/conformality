function [D, g, abs_eta] = form_system_namap(S, c, rho, norm_cond, ...
                                              centers, radii, rotations, N)
% FORM_SYSTEM_NAMAP Form the linear system for the non-annulus (general) case.
%   Replicates namap.form_system from +bounded_map/namap.m
%
